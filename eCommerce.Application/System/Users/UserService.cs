...
namespace eCommerce.Application.System.Users
{
    public class UserService : IUserService
    {
        ...
        public UserService(UserManager<User> userManager, SignInManager<User> signInManager, RoleManager<Role> roleManage, IConfiguration config)
        {
        ...
        public async Task<string> Authenticate(LoginRequest request)
        {
            ...
            if (user == null)
            {
                throw new eCommerceException($"Cannot find user name {request.UserName}");
            }
